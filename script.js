document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('input', function (e) {
      ...
      if (field.classList.contains(ERROR_CLASS)) {
        const isValid = validateField(field);
        if (isValid) showError(field, false);
      }
    });
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Success state (for non-AJAX forms, show briefly before submit)
  ...
  function collectAnimatables() {
    return Array.from(document.querySelectorAll(ANIMATION_SELECTOR)).filter(
      function (el) { return !el.classList.contains(ANIMATION_CLASS); }
    );
  }
  ...
  if ('IntersectionObserver' in window) {
    ...
    collectAnimatables().forEach(function (el) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0f5dfe54-cf38-4e89-8881-ec930daae3ac',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0f5dfe54-cf38-4e89-8881-ec930daae3ac';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0f5dfe54-cf38-4e89-8881-ec930daae3ac';
